...
export class SvgService {
  ...
  private icons: { [key: string]: string } = {
    ...
    fullHeart: `<svg xmlns="http://www.w3.org/2000/svg" height="24px" width="24px" viewBox="0 0 24 24" fill="none">
    ...
    saved: `<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
    ...
    homeFull: `<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
    ...
    <rect x="120" y="-840" width="720" height="720" fill="#5f6368"/>
    <path fill="white" d="M440-280h80v-160h160v-80H520v-160h-80v160H280v80h160v160Z"/>
    </svg>`,
